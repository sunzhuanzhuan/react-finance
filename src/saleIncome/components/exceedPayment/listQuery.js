...
import { Row, Col, Form, Button, Input, message, Icon } from "antd";
const FormItem = Form.Item;

class ExceedListQuery extends React.Component {
	constructor() {
		super();
		this.state = {
...
export default Form.create()(ExceedListQuery);
